...
describe('Pagination actions', () => {
  ...
  it('should go to page 0 that exists', () => {
  ...
  it('should go to page 1 that exists', () => {
  ...
  it('should go to page 1 when asked to go to 2 because we have only 2 pages [0,1]', () => {
  ...
  it('should go to page 0 from 1 when there are only 2 records', () => {
